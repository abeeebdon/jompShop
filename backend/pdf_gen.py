...
def _header_table(doc_title: str, doc_number: str, issue_date: str) -> Table:
    data = [
        [Paragraph("<b>HELIX PLATFORM</b>", ParagraphStyle("h", fontName="Helvetica-Bold", fontSize=14, textColor=GOLD)),
        ...
        [Paragraph("DobbleHelix Limited · Riby Inc · JompStart Digital · Powered by Anchor", ParagraphStyle("s", fontName="Helvetica", fontSize=8, textColor=TEAL)),
